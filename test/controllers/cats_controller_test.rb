...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference("Cat.count") do
      post cats_url, params: { cat: { age: @cat.age, deleted_at: @cat.deleted_at, name: @cat.name } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { age: @cat.age, deleted_at: @cat.deleted_at, name: @cat.name } }
